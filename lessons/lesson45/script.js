...
function init() {
  if (!leftDisplay || !rightDisplay || !feedbackEl || !scoreEl || !mascot) {
...
function handleIncorrect() {
  ...
  if (currentAttempts >= 2) {
    ...
    let correctAnswer = '=';
    if (currentLeftVal > currentRightVal) correctAnswer = '>';
    else if (currentLeftVal < currentRightVal) correctAnswer = '<';
